...
const HeadComponent = () => (
  <Head>
    ...
    <meta property="twitter:image:src" content="/images/logo-cloud.png" />
    <meta property="og:url" content={brand.cloud.url} />
    <meta property="og:title" content={brand.cloud.name} />
    <meta
      property="og:description"
      content={brand.cloud.desc}
    />
    <meta name="twitter:site" content={brand.cloud.url} />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:image" content={brand.cloud.img} />
    <meta property="og:image" content={brand.cloud.img} />
