...
export const useSpacing = makeStyles(theme => ({
  ...
  colouredPage: {
    ...
    backgroundImage: theme.palette.type === 'dark' ? `linear-gradient(120deg, ${theme.palette.primary.dark}, ${theme.palette.secondary.dark})` : `linear-gradient(120deg, ${theme.palette.primary.main}, ${theme.palette.secondary.main})`
  },
  spaceBottom: {
  ...
  maintenanceIcon: {
    ...
    width: 100,
    height: 100,
    background: theme.palette.type === 'dark' ? 'rgba(0, 0, 0, 0.12)' : 'rgba(255, 255, 255, 0.12)',
    '& svg': {
      fontSize: 64,
    },
  },
