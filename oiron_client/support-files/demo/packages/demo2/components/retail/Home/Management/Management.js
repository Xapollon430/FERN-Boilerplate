...
function Management(props) {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      sliderSide.current.slickGoTo(1);
    }, 100);
  }, []);
  ...
  return (
    <div className={classes.root}>
      <Title align="center">
        {t('common:retail-landing.management_title')}
      </Title>
      <Box px={{ sm: 15, xs: 4 }}>
        <p className={clsx(text.subtitle2, align.textCenter)}>
          {t('common:retail-landing.management_desc')}
        </p>
      </Box>
              ...
              >
                <div className={classes.paperRound}>
                  ...
                  <h4 className={text[item.color + 'Color']}>
                    {t('common:retail-landing.management_' + item.title)}
                  </h4>
                </div>
              </div>
            ))}
                  ...
                  <div className={classes.desc}>
                    <div>
                      ...
                      <div className={classes.text}>
                        ...
                        <p>{t('common:retail-landing.management_' + item.desc)}</p>
                      </div>
                    </div>
                  </div>
                </div>
...
export default withTranslation(['retail-landing'])(Management);
