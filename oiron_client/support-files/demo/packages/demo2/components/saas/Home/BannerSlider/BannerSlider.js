        ...
        >
                    ...
                    <Box px={3} alignItems="center">
                      <div className={classes.text}>
                        <h4 className={text.title2}>
                          {t('common:saas-landing.banner_title') + ' ' + t('common:saas-landing.banner_titlestrong')}
                        </h4>
          ...
          <div className={classes.slide}>
            <div className={classes.inner}>
              ...
              <Container>
                <Grid container spacing={2} alignItems="center" justify="flex-end" direction={isMobile ? 'column-reverse' : 'row'}>
                  <Grid item md={6} xs={12}>
                    <Box px={{ sm: 3 }}>
                      <div className={classes.img}>
...
export default withTranslation(['common', 'saas-landing'])(BannerSlider);
